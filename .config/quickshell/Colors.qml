...
QtObject {
		...
		readonly property color inverse_primary: "#435e91"
		...
		readonly property color primary: "#adc7ff"
	
		readonly property color primary_container: "#2a4678"
	
		readonly property color primary_fixed: "#d8e2ff"
	
		readonly property color primary_fixed_dim: "#adc7ff"
		...
		readonly property color source_color: "#394050"
		...
		readonly property color surface_tint: "#adc7ff"
